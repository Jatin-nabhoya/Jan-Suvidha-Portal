...
from .views import index,register,getRefreshToken,recaptcha,VerifyOtpView,SendOtpView, LoginView, UserView, LogoutView, registerScheme, requiredDocs,isStaff
